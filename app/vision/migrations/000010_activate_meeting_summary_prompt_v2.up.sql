...
BEGIN
    ...
    IF NOT FOUND THEN
        RAISE EXCEPTION 'active meeting summary provider config is required';
    END IF;

    IF active_config.prompt_version = 'meeting-summary-v2' THEN
        RETURN;
    END IF;

    IF active_config.prompt_version <> 'meeting-summary-v1' THEN
        RETURN;
    END IF;
    ...
    INSERT INTO meeting_summary_provider_configs (
        ...
        active_config.model_name, 'meeting-summary-v2',
